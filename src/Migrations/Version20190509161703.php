 ...
 */
final class Version20190509161703 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD category_id INT NOT NULL, DROP image_filename');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD image_filename VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP category_id');
    }
}
